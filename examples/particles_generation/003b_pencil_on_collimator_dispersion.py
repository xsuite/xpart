...
x_absolute, px_absolute = line.xpart.generate_2D_pencil_with_absolute_cut(num_particles,
...
y_in_sigmas, py_in_sigmas = line.xpart.generate_2D_gaussian(num_particles)
