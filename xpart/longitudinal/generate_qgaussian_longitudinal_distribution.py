...
def generate_qgaussian_longitudinal_coordinates(num_particles=None,
	...
	"""
	Function to generate a qGaussian longitudinal distribution
	...
	q : float
		q-Gaussia parameter, determines fatness of tails. q<1 means light tails, q=1 is Gaussian, q>1 means fat tails
